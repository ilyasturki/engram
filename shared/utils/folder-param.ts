...
export const videoNameSchema = v.pipe(
    v.string(),
    v.trim(),
    v.minLength(1),
    v.maxLength(MAX_NAME_LENGTH),
...
export const folderParamsSchema = v.strictObject({
    folderName: folderNameSchema,
})

export const videoParamsSchema = v.strictObject({
    folderName: folderNameSchema,
    videoName: videoNameSchema,
})
